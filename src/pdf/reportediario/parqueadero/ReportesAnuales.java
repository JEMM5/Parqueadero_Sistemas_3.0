...
public class ReportesAnuales {
    ...
    String mesNumero;
    public ReportesAnuales(String ano){
        this.ano = ano;
    ...
    public void GenerarReporteAnual(){
        ...
        String ruta = System.getProperty("user.home");
        PdfWriter.getInstance(documento, new FileOutputStream(ruta + "\\Desktop\\"+ano+".pdf"));
        ...
        tabla.addCell(t13);
           ...
           try{
               ...
               PreparedStatement pst = cn.prepareStatement("select * from parq where HoraEntrada like '%"+ano+"%'"+"AND Estado like '%"+"Retirado"+"%'");
           ...
           //
            ...
            Logger.getLogger(ReportesAnuales.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
}
